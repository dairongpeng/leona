...
import (
	...
	"github.com/dairongpeng/leona/pkg/util/homedir"
...
const (
	// RecommendedHomeDir defines the default directory used to place all leona service configurations.
	RecommendedHomeDir = ".leona"

	// RecommendedEnvPrefix defines the ENV prefix used by all leona service.
	RecommendedEnvPrefix = "LEONA"
)
...
func LoadConfig(cfg string, defaultName string) {
	...
	viper.SetEnvPrefix(RecommendedEnvPrefix) // set ENVIRONMENT variables prefix to LEONA.
