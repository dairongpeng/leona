...
import (
	...
	"github.com/dairongpeng/leona/pkg/cli/globalflag"
	"github.com/dairongpeng/leona/pkg/term"
	"github.com/dairongpeng/leona/pkg/version"
	"github.com/dairongpeng/leona/pkg/version/verflag"
...
func WithDefaultValidArgs() Option {
	return func(a *App) {
		a.args = func(cmd *cobra.Command, args []string) error {
			// The application's parameter checker, for a single service type, does not support passing args
...
func NewApp(appname string, basename string, opts ...Option) *App {
	app := &App{
		name:     appname,
		basename: basename,
	}

	// registering parameters to the app as a registered function
	for _, o := range opts {
		o(app)
	}
...
func (a *App) buildCommand() {
	...
	// If not set to start without a config profile, the config profile needs to be loaded
	if !a.noConfig {
