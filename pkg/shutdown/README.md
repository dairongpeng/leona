...
```
go get github.com/dairongpeng/leona/pkg/shutdown
```

## Documentation

`github.com/dairongpeng/leona/pkg/shutdown` documentation is available on [godoc](http://godoc.org/github.com/dairongpeng/leona/pkg/shutdown).

Both `ShutdownManagers` are also documented:
- [`PosixSignalManager`](http://godoc.org/github.com/dairongpeng/leona/pkg/shutdown/shutdownmanagers/posixsignal)
- [`AwsManager`](http://godoc.org/github.com/dairongpeng/leona/pkg/shutdown/shutdownmanagers/awsmanager)
...
import (
	...
	"github.com/dairongpeng/leona/pkg/shutdown/shutdownmanagers/awsmanager"
